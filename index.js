...
let greetings = [
  {
    ...
    message: "Sending hugs and kisses for the day ahead!",
  },
  {
  ...
  },
  {
    ...
    message:
      "Take a deep breath and relax your mind and think about all your worries",
  },
...
function typeWriter() {
  if (i <= main.length) {
    i === main.length
      ? (document.getElementById("content").innerHTML += "&hearts;")
...
if (now == 1) {
  ...
  document.getElementById("music").innerHTML =
    '<source src="music/Back To You - Selena Gomez.mp3" type="audio/mpeg">';
  ...
  document.getElementById("music").innerHTML =
    '<source src="music/One Kiss-Calvin Harris, Dua Lipa.mp3" type="audio/mpeg">';
  document.getElementById("music").play();
  document.getElementById("subContent").innerHTML = submain;
  ...
  document.body.style.backgroundColor = "#edf2f7";
  document.getElementById("music").innerHTML =
    '<source src="music/Jeremy Zucker & Chelsea Cutler - you were good to me.mp3" type="audio/mpeg">';
  document.getElementById("music").play();
  document.getElementById("subContent").innerHTML = submain;
}
